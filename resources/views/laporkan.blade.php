...
@section('content')
    ...
    <div class="max-w-5xl mx-auto pb-16 pt-8 px-4 sm:px-6 lg:px-8" x-data="{
        ...
        <div x-show="showPanduanModal" style="display: none;"
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-5xl h-[85vh] flex flex-col relative z-10 transform transition-all overflow-hidden"
                x-transition.scale>
                <div class="flex justify-between items-center px-6 py-4 border-b border-gray-100 bg-white shrink-0">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 bg-red-50 text-[#800000] rounded-lg flex items-center justify-center">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253">
                                </path>
                        ...
                        <h3 class="font-bold text-gray-900 text-base">Panduan Penggunaan Sistem</h3>
                    </div>
                ...
                <div class="flex-1 bg-gray-100 relative flex flex-col">
                    <iframe src="{{ asset('assets/aturan/panduan.pdf') }}" class="w-full h-full relative z-10 border-none"
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-5xl h-[85vh] flex flex-col relative z-10 transform transition-all overflow-hidden"
                ...
                <div class="flex justify-between items-center px-6 py-4 border-b border-gray-100 bg-white shrink-0">
                    <div class="flex items-center gap-3">
                        ...
                        <h3 class="font-bold text-gray-900 text-base" x-text="pdfTitle"></h3>
                    </div>
                ...
                <div class="flex-1 bg-gray-100 relative flex flex-col">
                    <div class="absolute inset-0 flex flex-col items-center justify-center text-gray-400 gap-3 z-0">
                        <svg class="w-6 h-6 animate-spin text-[#800000]" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="p-6 md:p-8 overflow-y-auto custom-scroll bg-white">
                    ...
                    <form action="{{ route('lapor.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select required name="jenis_kasus"
                                            ...
                                            <option value="Diskriminasi dan intoleransi">Diskriminasi dan Intoleransi
                                            </option>
                                        </select>
                                        <div
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block mb-2 text-sm font-bold text-gray-800">Tanggal Kejadian <span
                                            class="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label class="block mb-2 text-sm font-bold text-gray-800">Lokasi Kejadian Secara
                                        Spesifik <span class="text-red-500">*</span></label>
                            ...
                            {{-- Deskripsi --}}
                            <div>
                                <label class="block mb-2 text-sm font-bold text-gray-800">Kronologi Singkat & Jelas <span
                                        class="text-red-500">*</span></label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="flex flex-col h-full">
                                    <label class="block mb-2 text-sm font-bold text-gray-800">Tautan Bukti Video <span
                                            class="text-gray-400 font-medium text-xs">(Opsional)</span></label>
                                    <p class="mb-4 text-xs font-medium text-gray-500 leading-relaxed">Sertakan link Google
                                        Drive atau YouTube jika Anda memiliki bukti berupa rekaman suara/video.</p>
                                ...
                                <div class="flex flex-col h-full">
                                    <label class="block mb-2 text-sm font-bold text-gray-800">Unggah File Bukti Gambar
                                        <span class="text-gray-400 font-medium text-xs">(Opsional)</span></label>
                                    <div class="flex items-center justify-center w-full relative mt-auto h-[6rem]">
                                        <label for="dropzone-file"
                                            class="flex flex-col items-center justify-center w-full h-full border-2 border-gray-200 border-dashed rounded-xl cursor-pointer bg-gray-50 hover:bg-red-50 hover:border-[#800000]/30 transition-all relative overflow-hidden group">
