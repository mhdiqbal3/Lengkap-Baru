        ...
        <div x-show="showModal" style="display: none;"
            ...
            @elseif (isset($error))
                <div id="modal-content-error"
                    class="bg-white rounded-[2rem] shadow-2xl max-w-md w-full relative z-10 flex flex-col overflow-hidden transform transition-all"
                    ...
                    {{-- Body --}}
                    <div class="relative -mt-8 mx-5 bg-white rounded-2xl shadow-xl px-6 pt-6 pb-4 text-center border border-gray-100">
                        <p class="text-gray-600 text-sm font-medium leading-relaxed mb-5">
                            Kode tiket tidak ditemukan. Pastikan kode diketik dengan benar.
                        </p>
                    </div>
