...
<body class="bg-white text-gray-800 font-sans antialiased overflow-x-hidden" x-data="landingPageData()">
    @php
        ...
        // Tarik data bentuk kekerasan dari Dashboard
    ...
    <nav x-data="{ open: false, scrolled: false }" @scroll.window="scrolled = (window.pageYOffset > 10) ? true : false"
                    ...
                    <div x-data="{ dropdownOpen: false }" class="relative" @mouseenter="dropdownOpen = true"
                        ...
                        <div x-show="dropdownOpen" x-transition
                            ...
                            <a href="#panduan"
                                ...
                                Penggunaan</a>
                            <a href="#peraturan"
                                class="block px-4 py-2 text-[11px] font-bold hover:bg-red-50 hover:text-[#800000]">Peraturan</a>
                            <a href="#pencegahan"
        ...
        <div x-show="open" x-collapse
            ...
            <div class="px-4 pt-2 pb-4 space-y-1">
                ...
                <a href="#panduan" @click="open = false"
                    class="block px-3 py-2 text-xs font-bold hover:text-[#800000]">Panduan Penggunaan</a>
                    ...
                    try {
                        ...
                        if (!modalContent) {
                            doc.querySelectorAll('template').forEach(t => {
                                let found = t.content.querySelector('#modal-content-laporan') || t.content
                                    .querySelector('#modal-content-error');
    ...
    <template x-teleport="body">
        <div x-show="showErrorModal" style="display: none;"
            ...
            <div class="bg-white rounded-[2rem] shadow-2xl max-w-md w-full relative z-10 flex flex-col overflow-hidden"
                ...
                {{-- Header Gradient --}}
                <div
                    class="relative bg-gradient-to-br from-[#800000] via-red-800 to-rose-900 px-8 pt-10 pb-16 text-center overflow-hidden">
                    ...
                    <div class="relative inline-flex items-center justify-center mx-auto mb-4">
                        ...
                        <div
                            class="relative w-20 h-20 bg-white/20 rounded-full flex items-center justify-center border-2 border-white/30 shadow-lg backdrop-blur-sm">
                    ...
                    <h3 class="text-2xl font-black text-white tracking-tight drop-shadow-md">Laporan Tidak Ditemukan
                    </h3>
                    <p class="text-red-100/80 text-xs font-semibold mt-1 uppercase tracking-widest">Kode Tiket Tidak
                        Valid</p>
                </div>

                {{-- Body --}}
                <div
                    class="relative -mt-8 mx-5 bg-white rounded-2xl shadow-xl px-6 pt-6 pb-5 text-center border border-gray-100">
